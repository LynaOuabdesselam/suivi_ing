<html>
    ...
    <head>
        ...
        <script >
            ...
            var elmsN1 = document.querySelectorAll("[id='N1']");
            var elmsN2 = document.querySelectorAll("[id='N2']");
            ...
            for(var k = 0; k < elmsN1.length; k++) 
                elmsN1[k].style.backgroundColor ='#f2e394';

            for(var l = 0; l < elmsN2.length; l++) 
                elmsN2[l].style.backgroundColor ='#b1cbbb';
            }) 
        </script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="Informationsgénérales" class="tab-pane">
                <!-- *********************************************************************************** -->
                ...
                <!--_____________________________________________________________________________________________ -->
                                                            ...
                                                            <h4 style="text-align:left;"> Résultats :</h4>
                                                            <p><a href="index.php?page=studentGrades&idEtudiant=<?php echo $idEtudiant;?>" target="_blank">"Cliquez ici pour voir les notes de ce profil"</p>
