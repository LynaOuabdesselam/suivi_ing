...
<script type="text/javascript" src="Etudiant.js"></script>
    ...
    <form id="msform" method="post" action="addErasmus.php">
	 

    <fieldset>
       <h2 class="fs-title"><i class="fa fa-id-card" aria-hidden="true"></i>&nbsp;&nbsp;Informations étudiants (1/3) </h2>
        
       <div class="col-sm-14">
       
       <input autocomplete='off' type="text" name="idEtudiant" placeholder="Numéro d'étudiant *" required="required" id="idEtudiant"/>
       ...
       id="inputPrenom" />
       <input autocomplete='off' type="date" class="datepicker" name="DateBirth" placeholder="Date de naissance (AAAA-MM-JJ)" />
       <input autocomplete='off' type="text" name="EtudiantMail" placeholder="Mail (xyz@mail.fr)" id="EtudiantMail"/>
       <input autocomplete='off' type="text" name="EtudiantTel" placeholder="Numéro de telephone"/>
       <input autocomplete='off' type="text" name="EtudiantAdresse" placeholder=" Addresse*"  required="required"/>
       <input autocomplete='off' type="text" name="EtudiantBatiment" placeholder=" Batiment"/>
       <input autocomplete='off' type="text" name="EtudiantCP" placeholder="Code postale*" required="required" >
       <input autocomplete='off' type="text" name="EtudiantVille" placeholder="ville *" required="required"/>
        </div>     
       <input type="button" name="next" class="next action-button" value="Suivant" />
     </fieldset>
       
     <fieldset>
       <h2 class="fs-title"><i class="fa fa-user-circle" aria-hidden="true"></i>&nbsp;&nbsp;Université d'envoi (2/3) </h2>

       <div class="col-sm-14">
            
        </div>
        
        <select class="form-control" autocomplete='off' type="text" name="EtudeAnnee" placeholder="Années d'études *" required="required" id="EtudeAnnee">
              <option value=""> Années d'études </option>
              <option value="1st Year">Première Année</option>
              <option value="2nd Year">Deuxième année</option>
              <option value="3rd Year">Troisième année</option>
            </select>
            <br>
<select class="form-control" autocomplete='off' type="text" name="libelle" placeholder="Spécialités  *" required="required" id="libelle">
            ...
            <select class="form-control" autocomplete='off' type="text" name="semestre" placeholder="semestre *" required="required" id="semestre">
              <option value=""> Semestre d'échange * </option>
...
<div class="col-sm-14">
     <select class="form-control" autocomplete='off' type="text" name="EtudiantNation" placeholder="Etudiant Nationnalité *" required="required" id="EtudiantNationnalité">
     ...
     <br>
            ...
            <select class="form-control" autocomplete='off' type="text" name="bourse" placeholder="bourse *" required="required" id="bourse">
            ...
            <br>
            <select class="form-control" autocomplete='off' type="text" name="programme" placeholder="programme *" required="required" id="programme">
              <option value="">Type de programme* </option>
              <option value="ERASMUS+"> ERASMUS+</option>
              <option value="ERASMUS+"> BCI </option>
              <option value="MICEFA">MICEFA</option>
              <option value="Autre">Autres</option>
            </select>
            <br>
            
            <input autocomplete='off' type="text" name="Duree" placeholder="Durée d'échange *" required="required" id="Duree"/>
            <br>
            <input autocomplete='off' type="date" class="datepicker" name="Datedebut" placeholder="Datedebut (AAAA-MM-JJ) *" required="required" />
     ...
     <fieldset>
       <h2 class="fs-title"><i class="fa fa-plane" aria-hidden="true"></i>&nbsp;&nbsp; Université d'accueil (3/3) </h2>
       <div class="col-sm-14">
            <select class="form-control" autocomplete='off' type="text" name="PaysAcceuil" placeholder="Pays d'acceuil* *" required="required" id="PaysAcceuil">
          ...
          <input autocomplete='off' type="text" name="villeEchange" placeholder="ville d'échange " id="villeEchange"/>
          <input autocomplete='off' type="text" name="EcoleEchange" placeholder="Ecole ou univ d'acceuil " id="EcoleEchange"/>
       <input autocomplete='off' type="text" name="nombreECTS" placeholder="nombre ECTS*" required="required"/>
       <br>
            <select class="form-control" autocomplete='off' type="text" name="Langue" placeholder="Langue *" required="required" id="Langue">
              <option value="">Langue d'échange* </option>
              <option value="ERASMUS+">Anglais</option>
              <option value="MICEFA">Espagnole</option>
              <option value="MICEFA">Français</option> 
              <option value="Autre">Autres</option>
            </select>
            <br>
       <input type="button" name="previous" class="previous action-button" value="Précédent" />
